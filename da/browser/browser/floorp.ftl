...
tab-sleep-timeout-minutes-value = Faneblade vil sove efter at være inaktive i (minutter)
tab-sleep-settings-button = Indstillinger...
tab-sleep-settings-dialog-title = 
    .title = Indstillinger For Sovende Faneblade
tab-sleep-settings-dialog-excludehosts-label = Udeluk værter
tab-sleep-settings-dialog-excludehosts-label-2 = Angiv en vært pr. linje.
...
verticalTab-setting = 
    .label = Optimer browser til vertikal fanebjælke
move-tabbar-position = 
    .label = Vis fanebladslinje under værktøjslinjen
tabbar-on-bottom = 
    .label = Vis fanebladslinje nederst i vinduet
tabbar-favicon-color = 
    .label = Farve fanebladslinjen ved brug af nuværende hjemmesidens faviconfarve
tabbar-style-preference = Tab Bar Style
horizontal-tabbar = 
    .label = Vandret Fanebladslinje
tabbar-style-description = En genstart af { -brand-short-name } er nødvendig for fuldt ud at anvende denne indstilling.
multirow-tabbar = 
...
bsb-context = Brug følgende Container faneblad
bsb-userAgent-label = 
...
disable-blur-on-newtab = 
    .label = Deaktivér sløringseffekt på { -brand-short-name } Hjem
...
floorp-lepton-enable-urlname-go_button_when_typing = 
    .label = Vis en Go-knap ved indtastning
...
floorp-lepton-enable-tabbar-positon-as-titlebar = 
    .label = Fanebladslinje i titellinjen
...
change-to-close-workspace-popup-option = 
    .label = Luk arbejdsområder popup når du vælger et arbejdsområde
pinned-tabs-exclude-workspace-option = 
    .label = Udeluk fastgjorte faneblade fra arbejdsområder
workspaces-reset-title = Nulstil Arbejdsrum
...
change-workspace-with-default-key-option = 
    .label = Skift arbejdsområde med Shift og ↑ og ↓ nøgler.
workspaces-manage-title = Administrer Arbejdsrum
workspaces-manage-description = Administrer dine arbejdsområder. Skift arbejdsområde-ikon.
workspaces-manage-label = 
    .label = Administrer Arbejdsrum
workspaces-manage-button = Åbn Arbejdsrumshåndtering...
...
update-portable-notification-ready-message = { -brand-short-name } vil blive opdateret, når den starter næste.
...
workspace-error-discription = Enten findes der et arbejdsområde med dette navn eller navnet er ugyldigt.
workspace-button = Arbejdsrum
    .label = Arbejdsrum
    .tooltiptext = Vælg et arbejdsområde...
workspace-default = Standard
workspace-add = 
    .label = Nyt Arbejdsrum...
workspace-context-menu-selected-tab = 
    .label = Valgte fane kan ikke flyttes
move-tab-another-workspace = 
    .label = Flyt til et andet arbejdsområde
workspace-rename = 
    .label = Omdøb dette arbejdsområde
workspace-delete = 
...
welcome-discribe-floorp = { -brand-short-name } er en funktionsrig fleksibel browser, der understøtter forskellige miljøer og er baseret på Firefox.
welcome-start-setup = Klar til at hoppe ind?
...
welcome-enable-basic-features = Aktivér grundlæggende funktioner og indstillinger for en simpel oplevelse.
...
welcome-enable-most-of-features = Aktivér avancerede funktioner og indstillinger. Anbefales for erfarne brugere.
welcome-go-next-setup = Næste
welcome-select-browser-design = Vælg et browserdesign
welcome-discribe-browser-design = Du kan vælge en af de vidunderlige tredjeparts { -brand-short-name } designs. OS-specifikke designs er også tilgængelige ved præferencer.
...
start-input-button-listen = Begynd at lytte
end-input-button-listen = Stop lytning
shortcut-key-description = Klik på "Start med at lytte" og indtast din nye tastaturgenvej for denne handling. Flere nøgler kan bruges, men tastaturgenveje virker ikke hvis de allerede er tilknyttet andre handlinger.
...
floorp-custom-actions-enter-into-customize-mode = Angiv i værktøjslinjen Tilpas tilstand
    .label = Åbn Tilpas { -brand-short-name }
floorp-custom-actions-enter-into-offline-mode = Indtast i offline tilstand
...
floorp-custom-actions-open-bookmark-add-toolbar = Åbn bogmærke tilføj værktøjslinje
...
floorp-custom-actions-open-addons-manager = Åbn tilføjelseshåndtering
...
floorp-custom-actions-open-downloads = Åbn downloads
    .label = Åbn Downloads
floorp-custom-actions-show-bsm = Vis sidebjælke til browserhåndtering
    .label = Vis sidebjælken til browserhåndtering
...
floorp-split-view-menu = 
    .label = Ret denne fane for at opdele visning
######################################################################### Page Actions ###############################################################
