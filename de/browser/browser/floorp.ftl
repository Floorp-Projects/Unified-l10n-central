...
workspace-warning = Arbeitsbereiche können nicht zusammen mit Tab Gruppen Add-ons verwendet werden. Wenn Sie Tab Gruppen Add-ons verwenden möchten, deaktivieren Sie die Arbeitsbereiche und starten Sie { -brand-short-name } neu.
