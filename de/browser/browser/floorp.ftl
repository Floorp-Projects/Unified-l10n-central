...
enable-addons-in-sidebar2-with-experimental = 
    .label = Inhaltsskripte für Erweiterungen in der Seitenleiste des Browser-Managers aktivieren (experimentell)
enable-addons-in-sidebar2 = 
    .label = Inhaltsskripte für Erweiterungen in der Seitenleiste des Browser-Managers aktivieren
sidebar2-enable-addons-desc = Wenn diese Einstellung aktiviert ist, funktionieren Werbeblocker-Erweiterungen und andere Erweiterungen in der Seitenleiste. Es werden jedoch nicht alle Erweiterungen funktionieren.
...
welcome-describe-floorp = { -brand-short-name } ist ein funktionsreicher, flexibler Browser, der verschiedene Umgebungen unterstützt und auf Firefox basiert.
...
welcome-describe-browser-design = Sie können eines der wunderbaren { -brand-short-name } Designs von Drittanbietern auswählen. Betriebssystemspezifische Designs sind auch in den Einstellungen verfügbar.
