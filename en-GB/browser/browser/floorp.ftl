...
TST = Tree Style Tab
about-TST = Tree Style Tab is a popular add-on that allows you to display tabs in a tree structure. { -brand-short-name } 10 and above has a built-in version of this add-on. Please install the add-on restore { -brand-short-name } 10's built-in Tree Style Tab.
