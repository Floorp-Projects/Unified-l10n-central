...
workspaces-reset-description = Si una copia de respaldo no funciona y el espacio de trabajo no se inicia, restablezca el espacio de trabajo.
...
change-workspace-with-default-key-option = 
    .label = Cambie de espacio de trabajo con las teclas Mayús + ↑ y ↓.
...
workspace-default = Predeterminado
workspace-add = 
...
welcome-start-setup = ¿Listo/a para la acción?
...
welcome-discribe-browser-design = Puede elegir uno de los maravillosos diseños de terceros para { -brand-short-name }. También hay diseños específicos del sistema operativo disponibles en Preferencias.
...
welcome-import-data-description = Ponga a punto el navegador rápidamente. Importe marcadores, contraseñas y más. Si usa Firefox, puede importar datos desde Firefox Sync.
