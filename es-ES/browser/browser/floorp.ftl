...
native-vertical-tab-show-padding = 
    .label = Habilitar relleno en la parte superior
hover-vertical-tab = 
...
enable-addons-in-sidebar2-with-experimental = 
    .label = Habilitar scripts de contenido de extensiones en la barra lateral Gestor del navegador (experimental)
enable-addons-in-sidebar2 = 
    .label = Habilitar scripts de contenido de extensiones en la barra lateral Gestor del navegador
sidebar2-enable-addons-desc = Si esta opción está activada, las extensiones de bloqueo de anuncios y otras extensiones funcionarán en la barra lateral. Sin embargo, no todas las extensiones funcionarán.
...
dualtheme-enable = 
    .label = Activar tema dual (obsoleto)
floorp-enable-dualtheme-description = La función de Tema Dual puede causar problemas con las extensiones. Utilícela con precaución.
...
floorp-CSK-error = La combinación de teclas que ha introducido ya está en uso. Pruebe con otra combinación de teclas.
customize-Action = 
    .label = Añadir atajo
remove-Action = 
    .label = Quitar atajo
...
gf-floorp-close-browser-manager-sidebar-name = [{ -brand-short-name }] Cerrar BMS
...
welcome-describe-floorp = { -brand-short-name } es un navegador rico en funciones y flexible, compatible con varios entornos y basado en Firefox.
...
welcome-enable-basic-features = Habilitar funciones y ajustes básicos para disfrutar de una experiencia sencilla.
welcome-medium-template = Predeterminado
welcome-enable-some-features = Habilitar funciones y ajustes adicionales para disfrutar de una mejor experiencia.
...
welcome-describe-browser-design = Puede elegir uno de los maravillosos diseños de terceros para { -brand-short-name }. También hay diseños específicos del sistema operativo disponibles en Preferencias.
...
welcome-finish-setup-description = Ya está todo listo. Otras funciones como las Pestañas Verticales y los Espacios de Trabajo se encuentran en las Opciones de { -brand-short-name }. ¡Disfruta de { -brand-short-name }!
...
shortcut-key-description = Haga clic en "Empezar a escuchar" e introduzca su nuevo atajo de teclado para esta acción. Se pueden utilizar varias teclas; sin embargo, los atajos de teclado no funcionarán si ya están asignados a otras acciones.
...
floorp-custom-actions-show-bms = Alternar barra lateral gestor del navegador
    .label = Alternar la barra lateral Gestor del navegador
floorp-custom-actions-show-current-panel = Alternar panel actual
    .label = Alternar Panel Actual
...
floorp-custom-actions-hide-user-interface = Alternar Interfaz de Usuario
    .label = Alternar Interfaz de Usuario
floorp-custom-actions-toggle-navigation-panel = Alternar Panel de Navegación
    .label = Alternar Panel de Navegación
##################################################################### Profile Switcher ###############################################################
...
floorp-split-view-open-menu-disabled = 
    .label = Necesita una pestaña no divisible y deseleccionada
...
split-view-flex-type = Tipo Flex
...
close-tabs-to-the-start-on-vertical-tab-bar = 
    .label = Cerrar pestañas para empezar
    .accesskey = S
close-tabs-to-the-end-on-vertical-tab-bar = 
    .label = Cerrar pestañas hasta el final
    .accesskey = E
