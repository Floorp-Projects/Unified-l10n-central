...
enable-double-click-block = 
    .label = Cerrar pestañas al pulsar dos veces sobre ellas
...
material-effect = 
    .label = Permitir a Mica For Everyone modificar el diseño del navegador
...
enable-rest-mode = 
    .label = Activar atajo del modo de descanso (F9)
...
notes-backup-option = Configuración de copia de respaldo
...
workspaces-restore-warning = ¡Atención! Ejecutar esta operación sobrescribirá sus espacios de trabajo actuales. El navegador se congelará por unos segundos y se reiniciará.
...
pinned-tabs-exclude-workspace-option = 
    .label = Excluir pestañas ancladas de espacios de trabajo
...
workspaces-reset-service-title = Espacios de trabajo de { -brand-short-name }
...
welcome-enable-basic-features = Active funcionalidades y configuraciones básicas para una experiencia sencilla.
welcome-medium-template = Por defecto
welcome-enable-some-features = Active funcionalidades y configuraciones adicionales para una mejor experiencia.
welcome-maximum-template = Avanzado
welcome-enable-most-of-features = Active funcionalidades y configuraciones avanzadas. Recomendable para usuarios experimentados.
