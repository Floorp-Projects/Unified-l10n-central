...
tab-width = Ancho mínimo de pestañas
preferences-tabs-newtab-position = Nueva posición de pestaña
open-new-tab-use-default = 
    .label = Abrir nuevas pestañas en la posición predeterminada
open-new-tab-at-the-end = 
    .label = Abrir nuevas pestañas al final de la Barra de Pestañas
open-new-tab-next-to-current = 
    .label = Abrir nuevas pestañas junto a la pestaña actual
enable-multitab = 
    .label = Habilitar pestañas multifila
multirow-tabs-limit = 
    .label = Habilitar límite de fila para pestañas de varias filas
multirow-tabs-newtab = 
    .label = Coloque el botón "Abrir una nueva pestaña" al final de la fila más baja de pestañas
multirow-tabs-value = Número de filas cuando las pestañas de varias filas están habilitadas
enable-tab-sleep = 
    .label = Activar tabuladores dormidos
tab-sleep-timeout-minutes-value = Las pestañas dormirán después de estar inactivas durante (minutos)
tab-sleep-settings-button = Configuración...
tab-sleep-settings-dialog-title = 
    .title = Ajustes de tabulaciones dormidas
...
tab-sleep-tab-context-menu-excludetab = Mantener la pestaña despierta
enable-floorp-workspace = 
    .label = Activar espacios de trabajo
workspace-warring = Los espacios de trabajo no se pueden utilizar con los complementos de Tab Group. Si desea utilizar complementos de grupo de pestañas, desactive los espacios de trabajo y reinicie { -brand-short-name }.
enable-tab-scroll-change = 
    .label = Cambia las pestañas desplazándose con el ratón
enable-tab-scroll-reverse = 
    .label = Invertir dirección de las pestañas de desplazamiento
enable-tab-scroll-wrap = 
    .label = Envolver las pestañas de desguace en el borde
enable-double-click-block = 
    .label = Cerrar pestañas al hacer doble clic en ellas
enable-show-pinned-tabs-title = 
    .label = Mostrar el título de las pestañas fijadas
Mouse-side-button = 
    .label = Navegador opcional para el ratón con botones laterales
tabbar-preference = Barra de pestaña
None-mode = 
    .label = Modo normal
hide-horizontality-tabs = 
    .label = Ocultar pestañas en la barra de pestaña horizontal
verticalTab-setting = 
    .label = Navegador optimizado para la barra de pestaña vertical
move-tabbar-position = 
    .label = Mostrar barra de pestaña debajo de la barra de herramientas
tabbar-on-bottom = 
    .label = Mostrar barra de pestaña en la parte inferior de la ventana
tabbar-favicon-color = 
    .label = Colorear la barra de pestaña usando el color del favicon del sitio web actual
tabbar-style-preference = Tab Bar Style
horizontal-tabbar = 
    .label = Barra de pestaña horizontal
tabbar-style-description = Es necesario reiniciar { -brand-short-name } para aplicar completamente esta configuración.
multirow-tabbar = 
    .label = Barra de tabulador de múltiples filas
vertical-tabbar = 
    .label = Barra de pestaña vertical (experimental)
native-tabbar-tip = Los complementos de la barra lateral y las barras laterales incorporadas no pueden utilizarse al mismo tiempo como Pestañas Verticales ya que esta utiliza la barra lateral de Firefox.
native-vertical-tab-show-right = 
    .label = Mostrar barra de pestaña vertical en el lado derecho de la ventana
hover-vertical-tab = 
    .label = Colapsar barra de pestaña vertical
TST = Tabla de estilo árbol
about-TST = Tree Style Tab es un complemento popular que te permite mostrar pestañas en una estructura de árbol. Floorp 10 tiene un complemento incorporado. Por favor, instala la pestaña integrada de estilo árbol Floorp 10.
...
nav-bar-settings = Barra de herramientas
show-nav-bar-bottom = 
    .label = Mostrar la barra de herramientas en la parte inferior de { -brand-short-name } (experimental)
material-effect = 
    .label = Permitir a Mica para todos modificar el diseño del navegador
disable-extension-check-compatibility-option = 
    .label = No comprobar compatibilidad con complementos
other-preference = Otras preferencias
enable-userscript = 
    .label = Habilitar componentes heredados
about-legacy-components = Habilitar esta característica puede causar errores inesperados o errores fatales.
Search-positon-top = 
    .label = Mostrar la barra de búsqueda en la parte superior de la página
allow-auto-restart = 
    .label = Reiniciar automáticamente cuando se cambien los ajustes que requieren reiniciar
browser-rest-mode = 
    .label = Activar acceso directo al modo de descanso (F9)
disable-fullscreen-notification = 
    .label = No mostrar una notificación al entrar en pantalla completa
floorp-updater = { -brand-short-name } actualizaciones
enable-floorp-updater = 
    .label = Buscar actualizaciones { -brand-short-name } en el inicio
floorp-update-latest = 
    .label = Notificarme si { -brand-short-name } está actualizado durante las comprobaciones de actualizaciones automáticas
...
preferences-browser-appearance-description = Elige un diseño integrado de terceros para usar en { -brand-short-name }. Algunos diseños pueden no ser compatibles con tu configuración.
firefox-proton = 
    .label = Firefox Proton UI
firefox-proton-fix = 
    .label = Fijar IU de Firefox Proton
firefox-photon-lepton = 
    .label = IU de Lepton de Firefox
floorp-legacy = 
    .label = Floorp Legado UI no soportado
floorp-fluentUI = 
    .label = Microsoft Fluent UI
floorp-fluerialUI = 
    .label = Interfaz fluvial de Piso
floorp-gnomeUI = 
    .label = Tema GNOME

## Download Manager

download-notification-preferences = Descargar notificaciones
start-always-notify = 
    .label = Notificar solo al iniciar descargas
finish-always-notify = 
    .label = Notificar sólo cuando finalice una descarga
always-notify = 
    .label = Notificar al iniciar descargas y cuando finalice una descarga
do-not-notify = 
    .label = Desactivar notificaciones de descarga
floorp-translater = Configuración del traductor
click-to-option = 
...
profiles-button-label = Administrar perfiles
floorp-help-button-label = Soporte { -brand-short-name }
appmenuitem-reboot = 
    .label = Reiniciar
...
default-useragent-mode = 
    .label = Usar Firefox User Agent (por defecto)
windows-chrome-useragent-mode = 
    .label = Espoción de Chrome en Windows
macOS-chrome-useragent-mode = 
    .label = Espora de cromo en macOS
linux-chrome-useragent-mode = 
    .label = Espoción de Chrome en Linux
mobile-chrome-useragent-mode = 
    .label = Espora Chrome en iOS
...
download-mgr-UI = 
    .label = Habilitar el gestor de descargas de SimpleUI
downloading-red-color = 
    .label = Usar el icono de descargas rojas al descargar
sidebar-preferences = Sidebar
bsb-preferences = Ajustes de la barra lateral del administrador del navegador
view-sidebar2-right = 
    .label = Mostrar la barra lateral del administrador del navegador a la derecha
enable-sidebar2 = 
    .label = Activar la barra lateral del administrador del navegador
visible-bms = 
    .label = Mostrar la barra lateral del administrador del navegador
...
bsb-header = Barra lateral del administrador del navegador
bsb-context = Usar la siguiente pestaña de contenedor
bsb-userAgent-label = 
    .label = Usar agente de usuario móvil en este Panel Web
bsb-width = Ancho (si se establece en 0, se utilizará el valor global)
bsb-page = Página para abrir
bsb-add = Añadir Panel Web en la barra lateral del administrador del navegador
bsb-setting = Ajustes del Panel Web
bsb-add-title = 
    .title = { bsb-add }
bsb-setting-title = 
    .title = { bsb-setting }
...
use-icon-provider-option = Usar proveedor de iconos
...
max-memory = 
    .label = Mejor velocidad y rendimiento (alto uso de memoria)
...
disable-blur-on-newtab = 
    .label = Desactivar efecto de desenfoque en la casa { -brand-short-name }

## Lepton Preferences

about-lepton = Personalizar { -brand-short-name } con Lepton
lepton-preference-button = 
    .label = Ajustes de Lepton...
    .accesskey = L
lepton-header = Ajustes de Lepton
lepton-preference = Ajustes de Lepton
photon-mode = 
...
floorp-lepton-enable-tabbar-hide = 
    .label = Ocultar barra de pestaña
...
floorp-home-mode-choice-default = 
    .label = { -brand-short-name } Inicio (por defecto)
...
enable-notes-sync = 
    .label = Habilitar sincronización de notas { -brand-short-name }
about-notes-backup-tips = Floorp Notes utiliza Firefox Sync para sincronizar tus notas con otros dispositivos. Si pierdes tus notas, puedes restaurarlas desde una copia de seguridad. Cuando inicias { -brand-short-name } se crea una copia de seguridad.
...
notes-backup-option = Ajustes de copia de seguridad
backup-option-button = Configuración de copia de seguridad...
restore-from-backup-prompt-title = Servicio de restauración de notas floorp
restore-from-this-backup = ¿Restaurar notas al estado que estaban en esta copia de seguridad?
...
apply-userjs-attention2 = Por favor, haga una copia de seguridad de su archivo user.js actual antes de continuar.
...
default-userjs-label = Pantalón por defecto
...
about-Securefox = HTTPS-por-predeterminado. Protección total de cookies con aislamiento del sitio. Estado mejorado y particionado de red. Varias mejoras.
...
workspaces-backup-discription = Copia de seguridad y restauración de sus espacios de trabajo
workspaces-restore-service-title = Servicio de copia de seguridad de espacios de floorp
workspaces-restore-warning = ¡Atención! Ejecutar esta operación hará que el navegador se congele temporalmente y se reinicie automáticamente.
...
pinned-tabs-exclude-workspace-option = 
    .label = Excluir pestañas fijadas de espacios de trabajo
workspaces-reset-title = Restablecer espacios de trabajo
workspaces-reset-label = 
    .label = Restablecer espacios de trabajo
workspaces-reset-description = Si una copia de seguridad no funciona y el espacio de trabajo no se inicia, reinicie el espacio de trabajo.
workspaces-reset-button = Restablecer espacios de trabajo
workspaces-reset-service-title = Espacios de trabajo de Piso
workspaces-reset-warning = ¡Atención! Ejecutar esta operación eliminará todos sus espacios de trabajo y reiniciará el navegador.
manage-workspace-on-bms-option = 
    .label = Administrar espacio de trabajo en la barra lateral del administrador del navegador
show-workspace-name-option = 
    .label = Mostrar nombre del espacio de trabajo en el botón de espacio de trabajo de la barra de tabulación
change-workspace-with-default-key-option = 
    .label = Cambie el espacio de trabajo con Mayúsculas y teclas.
workspaces-manage-title = Administrar espacios de trabajo
workspaces-manage-description = Administre sus espacios de trabajo. Cambie el icono del área de trabajo.
...
floorp-CSK-description = Personalizar los atajos de teclado de { -brand-short-name }. Floorp proporciona más de 80 atajos de teclado personalizables - reinicia { -brand-short-name } para aplicar estos ajustes. Los atajos de teclado duplicados no funcionarán.
disable-fx-actions = 
    .label = Desactivar los atajos de teclado de Mozilla Firefox
customize-Action = 
    .label = Añadir acceso directo
remove-Action = 
...
CSK-reset-button = Restaurar valores por defecto
CSK-manage-title = Administrar atajos de teclado
CSK-remove-shortcutkey = ¿Eliminar acceso directo de teclado personalizado?
CSK-remove-shortcutkey-description = ¿Está seguro de que desea eliminar este atajo de teclado?
CSK-restore-default = ¿Restaurar valores por defecto?
CSK-restore-default-description = ¿Restaurar los atajos de teclado por defecto de Floorp? Se perderán los accesos directos actuales.
CSK-reboot-browser-label = Reiniciar { -brand-short-name } para aplicar estos ajustes
...
floorp-custom-actions-pip-action = Acciones de imagen en foto
...
floorp-custom-actions-bms-action = Acciones de barra lateral del administrador del navegador
floorp-custom-actions-workspace-action = Acciones de espacios de trabajo
...
privacy-hub-header = Hub de privacidad
...
block-fingerprint = La huella dactilar es un mecanismo de seguimiento que se basa en las características únicas de su navegador y sistema operativo. Esta sección contiene ajustes para mejorar aún más esta protección más allá del bloqueo predeterminado.
enable-firefox-fingerprint-protections = Habilitar una fuerte protección contra las huellas dactilares
about-firefox-fingerprint-protection = Activar la protección por Firefox incluye el modo de luz forzada, deshabilitar algunas APIs, etc. Algunos sitios pueden estar rotos.
...
WebRTC-connection = WebRTC es un estándar que proporciona llamadas en tiempo real. Si desactivas esta configuración, no podrás usar Discord, etc.
WebRTC = 
    .label = Habilitar conexión WebRTC
################################################################### browser ###############################################################

rest-mode = Tomando un descanso...
rest-mode-description = Floorp está actualmente suspendido. Pulse ENTRAR o OK para continuar.
Sidebar2 = 
    .label = Barra lateral del administrador del navegador
...
sidebar-keepWidth-button = 
    .tooltiptext = Sigue usando el ancho actual en este Panel
sidebar2-keep-width-for-global = 
    .label = Aplicar este ancho a todos los paneles sin un ancho personalizado
bsb-context-add = 
...
dual-theme-enabled-heading = Habilitado como un subtema
##################################################################### toolbar ###############################################################
...
gf-floorp-open-tree-style-tab-name = [Floorp] Abrir panel de pestaña estilo árbol
gf-floorp-open-tree-style-tab-description = Abrir Panel de pestaña de estilo árbol de la barra lateral
gf-floorp-open-bookmarks-sidebar-name = [Floorp] Abrir panel de marcadores de la barra lateral
gf-floorp-open-bookmarks-sidebar-description = Abrir panel de marcadores de la barra lateral
gf-floorp-open-history-sidebar-name = [Floorp] Abrir el panel de historia de la barra lateral
gf-floorp-open-history-sidebar-description = Abrir el panel de historial de la barra lateral
gf-floorp-open-synctabs-sidebar-name = [Floorp] Abrir panel de pestañas sincronizadas de la barra lateral
gf-floorp-open-synctabs-sidebar-description = Abrir panel de etiquetas sincronizadas de la barra lateral
gf-floorp-close-sidebar-name = [Floorp] cerrar barra lateral
gf-floorp-close-sidebar-description = Cerrar barra lateral
gf-floorp-open-browser-manager-sidebar-name = [Floorp] Abrir BMS
gf-floorp-open-browser-manager-sidebar-description = Abrir la barra lateral del administrador del navegador, si se cargó el panel web del administrador del navegador
gf-floorp-close-browser-manager-sidebar-name = [Floorp] cerrar BMS
gf-floorp-close-browser-manager-sidebar-description = Cerrar barra lateral del administrador del navegador
gf-floorp-show-browser-manager-sidebar-name = [Floorp] alternar BMS
gf-floorp-show-browser-manager-sidebar-description = Cambiar la barra lateral del administrador del navegador
gf-floorp-hide-statusbar-name = [Floorp] Ocultar barra de estado
gf-floorp-hide-statusbar-description = Ocultar barra de estado
gf-floorp-show-statusbar-name = [Floorp] Alternar barra de estado
gf-floorp-show-statusbar-description = Mostrar u ocultar barra de estado
gf-floorp-open-extension-sidebar-name = [Floorp] Abrir el complemento seleccionado de la barra lateral
gf-floorp-open-extension-sidebar-description = Abrir el complemento seleccionado de la barra lateral
...
open-link-in-external-enabled-option = 
    .label = Activar la función "Abrir en navegador externo"
...
memo-first-tip = ¡Bienvenido a Floorp Notes! ¡Aquí hay algunas instrucciones sobre cómo usarlo!
memo-second-tip = Floorp Notes es un bloc de notas que le permite almacenar múltiples notas que se sincronizan entre dispositivos. Para habilitar la sincronización, necesitas iniciar sesión en Floorp con tu cuenta de Firefox.
memo-third-tip = Las notas de Floorp se guardarán en la configuración de Floorp y se sincronizarán entre dispositivos usando Firefox Sync. Firefox Sync cifra el contenido de la sincronización con la contraseña de tu cuenta de Firefox, así que nadie más que tú conoce su contenido.
memo-import-data-tip = Firefox Sync no es un servicio de copia de seguridad. Te recomendamos que crees copias de seguridad.
memo-new-title = Nueva nota
chage-view-mode = Cambiar el modo de ver/edición
readonly-mode = Desconectado (sólo lectura)
######################################################################### Default bookmarks ###############################################################
default-bookmark-ablaze-support = Soporte de Ablaze
default-bookmark-notes = Notas de Piso
...
workspace-prompt-title = Espacio de trabajo de pistola
...
workspace-button = Espacios de trabajo
    ...
    .tooltiptext = Seleccione un espacio de trabajo...
workspace-default = Por defecto
workspace-add = 
    .label = Nuevo espacio de trabajo...
workspace-context-menu-selected-tab = 
    .label = La pestaña seleccionada no se puede mover
move-tab-another-workspace = 
    .label = Mover a otro espacio de trabajo
workspace-rename = 
    .label = Renombrar este espacio de trabajo
workspace-delete = 
...
welcome-discribe-floorp = { -brand-short-name } es un navegador flexible con características que soporta varios entornos y se basa en Firefox.
welcome-start-setup = ¿Listo para saltar?
welcome-skip-to-start-browsing = Saltar para empezar a navegar
welcome-select-preferences-template = Seleccione una plantilla
welcome-minimum-template = Básico
welcome-enable-basic-features = Activa funciones básicas y ajustes para una experiencia sencilla.
welcome-medium-template = Por defecto
welcome-enable-some-features = Habilitar funciones y ajustes adicionales para una mejor experiencia.
welcome-maximum-template = Avanzado
welcome-enable-most-of-features = Habilitar funciones y ajustes avanzados. Recomendado para usuarios experimentados.
welcome-go-next-setup = Siguiente
welcome-select-browser-design = Seleccione un diseño del navegador
welcome-discribe-browser-design = Puedes elegir uno de los maravillosos diseños de terceros { -brand-short-name } . Diseños específicos del sistema operativo también están disponibles en Preferencias.
...
welcome-design-floorp-fluerial-name = Diseño fluvial de Floorp
welcome-design-firefox-proton-name = Diseño de Firefox Proton
welcome-import-data = Importar tus datos del navegador
welcome-import-data-description = ¡Configuración rápida! Importa tus marcadores, contraseñas y más desde tu navegador antiguo. El usuario de Firefox puede importar datos de Firefox Sync.
welcome-import-data-button = Importar datos...
welcome-import-data-skip = Saltar importación
welcome-select-button = Seleccionar
welcome-finish-setup = ¡Configuración completada!
welcome-finish-setup-description = ¡Todo listo! Otros ajustes como Pestañas Verticales y Complementos se pueden encontrar en about:preferencias. ¡Disfruta { -brand-short-name }!
welcomet-finish-setup = Empezar a navegar por la web
############################################################# Custom Shortcutkey ###############################################################

category-CSK = 
    .label = Atajos del teclado
    .tooltiptext = Atajos del teclado
category-CSK-title = Atajos del teclado
...
start-input-button-listen = Empezar a escuchar
end-input-button-listen = Dejar de escuchar
shortcut-key-description = Haga clic en "Empezar a escuchar" e introduzca el nuevo acceso directo del teclado para esta acción. Se pueden usar varias teclas pero los atajos de teclado no funcionarán si ya están asignados a otras acciones.
floorp-custom-actions-open-new-tab = Abrir una nueva pestaña
...
floorp-custom-actions-open-new-private-window = Abrir una nueva ventana privada
    .label = Abrir una nueva ventana privada
...
floorp-custom-actions-show-page-info = Mostrar info de página
...
floorp-custom-actions-open-bookmark-add-toolbar = Abrir marcador añadir barra de herramientas
...
floorp-custom-actions-open-workspaces-preferences = Abrir preferencias de áreas de trabajo
...
floorp-custom-actions-open-addons-manager = Abrir gestor de complementos
...
floorp-custom-actions-manage-history = Administrar historial
    .label = Administrar historial
floorp-custom-actions-open-downloads = Abrir descargas
    .label = Abrir descargas
floorp-custom-actions-show-bsm = Mostrar barra lateral del administrador del navegador
    .label = Mostrar la barra lateral del administrador del navegador
floorp-custom-actions-show-bookmark-sidebar = Mostrar marcador lateral
    .label = Mostrar barra lateral de marcadores
...
floorp-custom-actions-hide-sidebar = Hide sidebar
    .label = Hide sidebar
floorp-custom-actions-show-sidebar = Cambiar barra lateral
    .label = Cambiar barra lateral
...
floorp-custom-actions-open-next-workspace = Abrir siguiente área de trabajo
    .label = Abrir siguiente área de trabajo
...
open-in_private-container = 
    .label = Abrir en nueva pestaña con contenedor privado
######################################################################## Split View ###############################################################
...
qrcode-generate-page-action = 
    .tooltiptext = Comparte esta página con tu teléfono
######################################################################### Customize Mode ###############################################################
