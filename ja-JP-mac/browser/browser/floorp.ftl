...
tab-sleep-settings-dialog-excludehosts-label-2 = 1 行に 1 つのホストを入力してください。
...
floorp-lepton-enable-toolbar-overlap = 
    .label = ツールバーをアドレスバーと重ねる
floorp-lepton-enable-toolbar-overlap-allow-layout-shift-autohide = 
    .label = ツールバーをアドレスバーと重ねる (自動非表示を有効にするとレイアウトが崩れる場合があります)
