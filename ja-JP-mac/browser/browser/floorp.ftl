...
enable-tab-sleep = 
    .label = タブスリープを有効にする
tab-sleep-timeout-minutes-value = スリープ状態にするまでの時間 (分)
...
change-workspace-with-default-key-option = 
    .label = ワークスペースを Shift + 矢印キーで切り替える
workspaces-manage-title = ワークスペースを管理
workspaces-manage-description = ワークスペースを管理します。アイコンを変更できます。
...
CSK-remove-shortcutkey-description = 本当にこのショートカットを削除しますか？
...
mouse-gesture-description = { -brand-short-name } でマウスジェスチャを使用するには、Gesturefy をインストールする必要があります。
Gesturefy = Gesturefy
...
gf-floorp-open-tree-style-tab-description = ツリー型タブをサイドバーで開く
gf-floorp-open-bookmarks-sidebar-name = [Floorp] サイドバーでブックマークを開く
gf-floorp-open-bookmarks-sidebar-description = ブックマークをサイドバーで開く
...
gf-floorp-open-synctabs-sidebar-description = 同期タブをサイドバーで開く
...
gf-floorp-open-browser-manager-sidebar-description = ウェブパネルが読み込まれている場合、ブラウザーマネージャーサイドバーを開く
gf-floorp-close-browser-manager-sidebar-name = [Floorp] BMS を閉じる
gf-floorp-close-browser-manager-sidebar-description = ブラウザーマネージャーサイドバーを閉じる
gf-floorp-show-browser-manager-sidebar-name = [Floorp] BMS の表示を切り替える
gf-floorp-show-browser-manager-sidebar-description = ブラウザマネージャーサイドバーを表示/非表示
...
gf-floorp-show-statusbar-description = ステータスバーを表示/非表示
gf-floorp-open-extension-sidebar-name = [Floorp] サイドバーで選択したアドオンを開く
gf-floorp-open-extension-sidebar-description = サイドバーで指定したアドオンを開く
gf-floorp-open-extension-sidebar-settings-addons-id = アドオン ID
gf-floorp-open-extension-sidebar-settings-addons-id-description = サイドバーで開くアドオン
...
update-portable-notification-failed-title = アップデート失敗
...
floorp-portable-update-application-allow = { -brand-short-name } Portable アップデート
...
memo-third-tip = Floorp Notes は Floorp に保存され、Firefox Sync を使用してデバイス間で同期されます。 Firefox Sync は、同期の内容を Firefox アカウントのパスワードで暗号化するため、誰にその内容を知られることはありません。
...
welcome-skip-to-start-browsing = スキップして閲覧を開始
...
welcome-import-data = ブラウザーデータをインポート
welcome-import-data-description = 一瞬でセットアップ！以前のブラウザーからブックマークやパスワードなどをインポートできます。Firefox ユーザーは Firefox Sync からデータをインポートできます。
...
floorp-custom-actions-back = 戻る
    .label = 戻る
floorp-custom-actions-forward = 進む
    .label = 進む
floorp-custom-actions-reload = 再読み込み
    .label = 再読み込み
floorp-custom-actions-stop = 読み込みを停止
    .label = 読み込みを停止
...
floorp-custom-actions-open-bookmark-add-tool = ブックマークを追加
    .label = ブックマークを追加
...
floorp-custom-actions-open-downloads = ダウンロードを開く
    .label = ダウンロードを開く
floorp-custom-actions-show-bsm = ブラウザーマネージャーサイドバーを開く
    .label = ブラウザーマネージャーサイドバーを開く
...
floorp-custom-actions-open-next-workspace = 次のワークスペースを開く
    .label = 次のワークスペースを開く
floorp-custom-actions-show-panel-1 = パネル 1 に切り替える
    .label = パネル 1 に切り替える
floorp-custom-actions-show-panel-2 = パネル 2 に切り替える
    .label = パネル 2 に切り替える
floorp-custom-actions-show-panel-3 = パネル 3 に切り替える
    .label = パネル 3 に切り替える
floorp-custom-actions-show-panel-4 = パネル 4 に切り替える
    .label = パネル 4 に切り替える
floorp-custom-actions-show-panel-5 = パネル 5 に切り替える
    .label = パネル 5 に切り替える
floorp-custom-actions-show-panel-6 = パネル 6 に切り替える
    .label = パネル 6 に切り替える
floorp-custom-actions-show-panel-7 = パネル 7 に切り替える
    .label = パネル 7 に切り替える
floorp-custom-actions-show-panel-8 = パネル 8 に切り替える
    .label = パネル 8 に切り替える
floorp-custom-actions-show-panel-9 = パネル 9 に切り替える
    .label = パネル 9 に切り替える
floorp-custom-actions-show-panel-10 = パネル 10 に切り替える
    .label = パネル 10 に切り替える
