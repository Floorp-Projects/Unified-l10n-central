...
gf-floorp-open-bookmarks-sidebar-name = [{ -brand-short-name }] サイドバーでブックマークを開く
gf-floorp-open-bookmarks-sidebar-description = ブックマークをサイドバーで開きます。
gf-floorp-open-history-sidebar-name = [{ -brand-short-name }] サイドバーで履歴を開く
gf-floorp-open-history-sidebar-description = 履歴をサイドバーで開きます。
gf-floorp-open-synctabs-sidebar-name = [{ -brand-short-name }] サイドバーで同期タブを開く
...
gf-floorp-open-extension-sidebar-name = [{ -brand-short-name }] 選択したサイドバーのアドオンを開く
...
please-enter-workspace-name-2 = 20 文字以内で入力してください。記号や空白を含めることはできません。
workspace-error = エラー:
...
shortcut-key-description = [キー読み取り開始] をクリックして、ショートカットとして使用したいキーを押します。一部では複数のキーを使用することもできます。他のアクションと重複しないようにしてください。
