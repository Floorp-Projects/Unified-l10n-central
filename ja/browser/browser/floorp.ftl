...
welcome-discribe-browser-design = サードパーティによる素晴らしいデザインから { -brand-short-name } の見た目を選択できます。OS 固有のデザインも設定で利用可能です。
...
shortcut-key-description = [キー読み取り開始] をクリックして、ショートカットとして使用したいキーを押します。複数のキーを使用することもできます。他のアクションと重複しないようにしてください。
