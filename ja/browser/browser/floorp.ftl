...
about-Fastfox = Floorp の閲覧速度を圧倒的に向上させる。Chrome 以上の速度を！
Peskyfox-label = Yokoffing Peskyfox
about-Peskyfox = 新しいタブページの整理をする。Pocketを削除する。コンパクトモードをオプションで復活させる。ウェブページの通知、ポップアップ、その他の迷惑行為を停止する。
...
floorp-workspace-settings-button = ワークスペースの設定と管理
...
workspaces-reset-button = ワークスペースをリセットする
...
change-workspace-with-default-key-option = 
    .label = ワークスペースを ↑ または ↓ キーとSHIFT キーを同時押しで切り替える
...
sidebar2-mute-and-unmute = 
    .label = このパネルの音声をミュート/ミュート解除する
sidebar2-unload-panel = 
    .label = このパネルをアンロードする
sidebar2-change-ua-panel = 
    .label = このパネルのユーザーエージェントをモバイル/デスクトップに切り替える
...
show-notes-sidebar = 
    .tooltiptext = { sidebar2-notes-sidebar }を表示する
sidebar-add-button = 
    .tooltiptext = { bsb-add }
sidebar-addons-button = 
    .tooltiptext = アドオンとテーマを開く
...
sidebar2-keep-width-for-global = 
    .label = 現在の幅をウェブパネルの幅のグローバル値として設定する
bsb-context-add = 
...
gf-floorp-show-browser-manager-sidebar-name = [Floorp] BMSの表示を切り替える
gf-floorp-show-browser-manager-sidebar-description = Floorp のブラウザマネージャーサイドバーを表示または非表示にします。
gf-floorp-hide-statusbar-name = [Floorp] ステータスバーを非表示にする
gf-floorp-hide-statusbar-description = Floorpのステータスバーを非表示にします。
gf-floorp-show-statusbar-name = [Floorp] ステータスバーの表示の切り替え
gf-floorp-show-statusbar-description = Floorpのステータスバーを表示または非表示にします。
...
update-portable-notification-ready-message = 次回{ -brand-short-name }起動時にアップデートが開始されます。
...
memo-import-data-tip = Floorp Notes は、Floorp のブラウザーマネージャーサイドバーで開くことができます。
memo-new-title = 新規メモ
...
floorp-custom-actions-show-previous-tab = 前のタブを表示
    .label = 前のタブを表示
floorp-custom-actions-show-all-tabs-panel = タブ一覧を表示
    .label = タブ一覧を表示
...
floorp-custom-actions-show-bookmark-toolbar = ブックマークツールバーの表示の切り替え
    .label = ブックマークツールバーの表示の切り替え
...
floorp-custom-actions-open-addons-manager = アドオンとテーマを開く
    .label = アドオンとテーマを開く
...
floorp-custom-actions-open-downloads = ダウンロードを開く
    .label = ダウンロードを開く
floorp-custom-actions-show-bsm = ブラウザーマネージャーサイドバーを表示
...
floorp-custom-actions-hide-sidebar = サイドバーを隠す
    .label = サイドバーを隠す
floorp-custom-actions-show-sidebar = サイドバーの表示を切り替え
    .label = サイドバーの表示を切り替え
