...
vertical-tabbar = 
    .label = 垂直タブバー (実験的)
native-tabbar-tip = サイドバーを使用するアドオンと垂直タブは併用できません。
...
allow-auto-restart = 
    .label = 再起動が必要な設定が変更された場合、自動的に再起動する。
browser-rest-mode = 
    .label = レストモードを有効にするショートカット (F9)
...
floorp-update-latest = 
    .label = 自動更新のチェック時に { -brand-short-name } が最新の状態であることを通知する
...
default-useragent-mode = 
    .label = Firefox のユーザーエージェント (デフォルト) を使用する
windows-chrome-useragent-mode = 
    .label = Windows 上の Chrome に偽装する
macOS-chrome-useragent-mode = 
    .label = macOS 上の Chrome に偽装する
linux-chrome-useragent-mode = 
    .label = Linux の Chrome に偽装する
mobile-chrome-useragent-mode = 
    .label = iOS 上の Chrome に偽装する
...
download-mgr-UI = 
    .label = シンプルなダウンロードマネージャーの UI を有効にする
downloading-red-color = 
    .label = ダウンロード時に赤いダウンロードアイコンを使用する
sidebar-preferences = サイドバー
bsb-preferences = ブラウザーマネージャーサイドバー設定
view-sidebar2-right = 
    .label = ブラウザマネージャサイドバーを右側に表示する
enable-sidebar2 = 
    .label = ブラウザマネージャーサイドバーを有効にする
visible-bms = 
    .label = ブラウザマネージャーサイドバーを表示
...
bsb-context = 以下のコンテナタブを使用
bsb-userAgent-label = 
    .label = この Web パネルではモバイル版のユーザーエージェントを使用する
bsb-width = 幅 (0 に設定されている場合、グローバル値が使用されます)
bsb-page = 開くページ
bsb-add = ブラウザマネージャーサイドバーにウェブパネルを追加
...
balance-memory = 
    .label = メモリ使用量とパフォーマンスのバランスをとる
max-memory = 
    .label = 最高の速度と最高のパフォーマンス (高メモリ使用量)
...
dualtheme-enable = 
    .label = デュアルテーマを有効にする
newtab-background = { -brand-short-name } Home 背景
newtab-background-random-image = 
    .label = Unsplash からのランダムな画像
...
newtab-background-extensions = これらのファイル拡張子を持つ画像のみを使用してください ("," で分けられています)
...
lepton-preference = Lepton の設定
photon-mode = 
    .label = Photon デザインを使用する
lepton-mode = 
    .label = Lepton のデザインを使用
protonfix-mode = 
    .label = Proton Fox のデザインを使用する
autohide-preference = ブラウザー要素を自動的に非表示にする
