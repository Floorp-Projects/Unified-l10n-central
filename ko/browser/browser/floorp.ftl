...
welcome-describe-floorp = { -brand-short-name } 는 다양한 환경을 지원하는, 기능이 풍부하고 유연한 Firefox기반의 브라우저입니다.
...
welcome-describe-browser-design = 서드파티의 멋진 디자인으로부터 { -brand-short-name } 의 디자인을 선택할 수 있어요. OS에 고유 디자인도 설정에서 선택할 수 있어요.
