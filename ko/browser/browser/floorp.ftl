...
enable-multitab = 
    .label = 다중 행 탭 사용
multirow-tabs-limit = 
    .label = 다중 행 탭에 행 제한 사용
multirow-tabs-newtab = 
    .label = 탭의 맨 아래 줄 끝에 '새 탭 열기' 버튼을 배치합니다.
multirow-tabs-value = 다중 행 탭이 활성화된 경우 행 수
enable-tab-sleep = 
    .label = 잠자기 탭 사용
tab-sleep-timeout-minutes-value = 탭이 (분) 동안 비활성화된 후 절전 모드로 전환됩니다.
...
hide-horizontality-tabs = 
    .label = 가로 탭 표시줄에서 탭 숨기기
verticalTab-setting = 
    .label = 세로 탭 표시줄에 맞게 브라우저 최적화
move-tabbar-position = 
    .label = 도구 모음 아래에 탭 표시줄 표시
tabbar-on-bottom = 
    .label = 창 하단에 탭 표시줄 표시
tabbar-favicon-color = 
    .label = 현재 웹사이트의 파비콘 색상을 사용하여 탭 표시줄의 색상을 지정합니다.
tabbar-style-preference = 탭 바 스타일
horizontal-tabbar = 
    .label = 가로 탭 표시줄
tabbar-style-description = 이 설정을 완전히 적용하려면 { -brand-short-name } 을 다시 시작해야 합니다.
multirow-tabbar = 
    .label = 다중 행 탭 표시줄
vertical-tabbar = 
    .label = 세로 탭 표시줄(실험적)
native-tabbar-tip = 사이드바 애드온과 내장 사이드바는 세로 탭과 동시에 사용할 수 없는데, 이는 Firefox 사이드바를 활용하기 때문입니다.
...
bookmarks-bottom-mode = 
    .label = { -brand-short-name }하단에 북마크 도구 모음을 표시합니다.
nav-bar-settings = 도구 모음
show-nav-bar-bottom = 
    .label = { -brand-short-name } 하단에 툴바 표시(실험적)
material-effect = 
    .label = Mica For Everyone이 브라우저 디자인 수정 허용
disable-extension-check-compatibility-option = 
    .label = 애드온과의 호환성을 확인하지 마세요.
other-preference = 기타 기본 설정
enable-userscript = 
    .label = 레거시 구성 요소 사용
...
floorp-update-latest = 
    .label = 자동 업데이트 확인 시 { -brand-short-name } 가 최신 상태인지 알려주세요.

## Browser Theme

system-color-settings = 일부 테마에는 밝은 모드와 어두운 모드가 모두 있으므로 이러한 테마에 사용할 모드를 선택하세요.
...
firefox-proton = 
    .label = Firefox 양성자 UI
firefox-proton-fix = 
    .label = Firefox 양성자 수정 UI
firefox-photon-lepton = 
    .label = Firefox 광자・렙톤 UI
floorp-legacy = 
    .label = Floorp 레거시 UI・미지원
floorp-fluentUI = 
    .label = Microsoft 플루언트 UI
floorp-fluerialUI = 
    .label = 플로어프 플루어리얼 UI
floorp-gnomeUI = 
    .label = GNOME 테마
...
download-notification-preferences = 알림 다운로드
start-always-notify = 
...
view-sidebar2-right = 
    .label = 오른쪽에 브라우저 관리자 사이드바를 표시합니다.
enable-sidebar2 = 
...
about-lepton = 렙톤으로 { -brand-short-name } 사용자 지정
lepton-preference-button = 
    .label = 렙톤 설정...
    .accesskey = L
lepton-header = 렙톤 설정
lepton-preference = 렙톤 설정
photon-mode = 
    .label = 광자 디자인 사용
lepton-mode = 
    .label = 렙톤 디자인 사용
protonfix-mode = 
    .label = 조정된 프로톤 디자인 사용
...
about-notes-backup-tips = 플로어피 노트는 Firefox 동기화를 사용해 노트를 다른 장치와 동기화합니다. 노트를 잃어버린 경우, 백업에서 복원할 수 있습니다. { -brand-short-name }을 시작하면 백업이 생성됩니다.
...
restore-from-backup-prompt-title = 플로어 노트 복원 서비스
...
userjs-customize = 사용자 정의 { -brand-short-name } 사용자 정의
...
apply-userjs-button = 신청하기

## userjs Options

default-userjs-label = 바닥 기본값
about-default-userjs = 원격 측정이 비활성화되었습니다. 다양한 사용자 지정이 활성화된 균형 잡힌 { -brand-short-name } .
Securefox-label = 요코핑 시큐어폭스
about-Securefox = 기본적으로 HTTPS. 사이트 격리를 통한 완벽한 쿠키 보호. 향상된 상태 및 네트워크 파티셔닝. 기타 다양한 개선 사항.
default-label = 요코핑 기본값
about-default = 모든 필수품. 깨지는 건 하나도 없습니다. 이것이 사용자.js입니다.
Fastfox-label = 요코핑 패스트폭스
about-Fastfox = Firefox의 브라우징 속도를 대폭 향상하세요. Chrome을 압도하세요!
Peskyfox-label = 요코핑 페스키폭스
about-Peskyfox = 새 탭 페이지를 깔끔하게 정리합니다. 포켓을 제거합니다. 옵션으로 컴팩트 모드를 복원합니다. 웹 페이지 알림, 팝업 및 기타 성가신 알림을 중지합니다.
Smoothfox-label = 요코핑 스무스폭스
about-Smoothfox = 즐겨 사용하는 브라우저에서 Edge와 같은 부드러운 스크롤을 사용하거나 자신의 스타일에 맞는 브라우저를 선택하세요.

## Workspaces

floorp-workspaces-title = { -brand-short-name } 작업 공간
workspaces-backup-discription = 워크스페이스 백업 및 복원
workspaces-restore-service-title = 플로어피 워크스페이스 백업 서비스
workspaces-restore-warning = 경고! 이 작업을 실행하면 브라우저가 일시적으로 정지되었다가 자동으로 다시 시작됩니다.
floorp-workspace-settings-button = 작업 공간 설정...
change-to-close-workspace-popup-option = 
    .label = 워크스페이스를 선택하면 워크스페이스 닫기 팝업이 나타납니다.
pinned-tabs-exclude-workspace-option = 
    .label = 작업 영역에서 고정된 탭 제외하기
workspaces-reset-title = 작업 공간 재설정
workspaces-reset-label = 
    .label = 작업 공간 재설정
workspaces-reset-description = 백업이 작동하지 않고 워크스페이스가 시작되지 않으면 워크스페이스를 재설정하세요.
workspaces-reset-button = 작업 공간 재설정
workspaces-reset-service-title = 바닥재 작업 공간
workspaces-reset-warning = 경고! 이 작업을 실행하면 모든 워크스페이스가 삭제되고 브라우저가 다시 시작됩니다.
manage-workspace-on-bms-option = 
    .label = 브라우저 관리자 사이드바에서 작업 영역 관리하기
show-workspace-name-option = 
    .label = 탭 표시줄의 작업 영역 버튼에 작업 영역 이름 표시
change-workspace-with-default-key-option = 
    .label = Shift 키와 ↑ 및 ↓ 키를 사용하여 작업 공간을 변경합니다.
workspaces-manage-title = 작업 공간 관리
workspaces-manage-description = 작업 공간 관리. 작업 공간 아이콘을 변경합니다.
workspaces-manage-label = 
    .label = 작업 공간 관리
workspaces-manage-button = 작업 공간 관리자 열기...
select-workspace = 작업 공간 선택
workspace-select-icon = 작업 공간 아이콘 선택
    .label = 작업 공간 아이콘 선택
...
floorp-CSK-title = 사용자 지정 키보드 단축키
floorp-CSK-description = { -brand-short-name }의 키보드 단축키를 사용자 지정합니다. Floorp는 80개 이상의 사용자 지정 가능한 키보드 단축키를 제공합니다. 이러한 설정을 적용하려면 { -brand-short-name } 을 다시 시작하세요. 중복된 키보드 단축키는 작동하지 않습니다.
disable-fx-actions = 
...
remove-Action = 
    .label = 바로 가기 제거
CSK-reset-title = 사용자 지정 키보드 단축키 재설정
CSK-reset-description = 사용자 지정 키보드 단축키를 { -brand-short-name }의 기본값으로 재설정합니다.
CSK-reset-label = 사용자 지정 키보드 단축키 재설정
...
CSK-restore-default-description = 플로어프의 기본 키보드 단축키를 복원하시겠습니까? 현재 단축키가 손실됩니다.
CSK-reboot-browser-label = { -brand-short-name } 을 다시 시작하여 다음 설정을 적용합니다.
CSK-reboot-browser-button = 다시 시작 { -brand-short-name }
...
floorp-custom-actions-tab-action = 탭 작업
floorp-custom-actions-page-action = 페이지 작업
floorp-custom-actions-visible-action = 표시되는 작업
floorp-custom-actions-search-action = 검색 작업
floorp-custom-actions-tools-action = 도구 작업
floorp-custom-actions-bookmark-action = 북마크 작업
floorp-custom-actions-open-page-action = 페이지 열기 작업
floorp-custom-actions-history-action = 히스토리 작업
floorp-custom-actions-pip-action = 화면 속 화면 작업
floorp-custom-actions-downloads-action = 다운로드 작업
floorp-custom-actions-sidebar-action = 사이드바 작업
floorp-custom-actions-bms-action = 브라우저 관리자 사이드바 작업
floorp-custom-actions-workspace-action = 작업 영역 작업
floorp-custom-actions-custom-action = 사용자 지정 작업(실험적)
...
sidebar2-keep-width-for-global = 
    .label = 사용자 지정 너비 없이 모든 패널에 이 너비를 적용합니다.
bsb-context-add = 
    .label = 웹 패널에 페이지 추가...
...
welcome-discribe-browser-design = 멋진 타사 디자인( { -brand-short-name } ) 중 하나를 선택할 수 있습니다. 환경설정에서 OS별 디자인도 사용할 수 있습니다.
...
floorp-custom-actions-open-bookmark-add-tool = 북마크 추가 도구 열기
    .label = 북마크 추가
floorp-custom-actions-open-bookmark-add-toolbar = 북마크 열기 도구 모음 추가
    .label = 북마크에 추가 도구 모음
...
floorp-custom-actions-open-addons-manager = 애드온 관리자 열기
    .label = 애드온 및 테마 열기
