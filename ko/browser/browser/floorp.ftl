...
pinned-tabs-exclude-workspace-option = 
    .label = 워크스페이스에서 고정된 탭 제외하기
workspaces-reset-title = 워크스페이스 초기화
...
workspaces-reset-service-title = { -brand-short-name } 워크스페이스
...
change-workspace-with-default-key-option = 
    .label = Shift 키와 ↑ 및 ↓ 키를 사용하여 워크스페이스를 변경합니다.
workspaces-manage-title = 워크스페이스 관리
workspaces-manage-description = 당신의 워크스페이스를 관리하세요. 당신의 워크스페이스 아이콘을 바꾸세요.
workspaces-manage-label = 
    .label = 워크스페이스 관리
workspaces-manage-button = 워크스페이스 관리자 열기...
