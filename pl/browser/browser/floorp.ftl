...
enable-tab-sleep = 
    .label = Włącz Śpiące Zakładki
tab-sleep-timeout-minutes-value = Zakładki będą uśpione po nieaktywności przez (minuty)
...
tabbar-favicon-color = 
    .label = Koloruj pasek zakładki używając koloru favicon obecnej strony
tabbar-style-preference = Tab Bar Style
horizontal-tabbar = 
    .label = Pasek zakładki poziomej
...
floorp-lepton-enable-centered-tab = 
    .label = Wyśrodkuj etykiety w zakładkach
...
workspaces-restore-warning = Ostrzeżenie! Uruchomienie tej operacji spowoduje tymczasowe zawieszenie przeglądarki i jej automatyczne ponowne uruchomienie.
...
workspace-select-container = Wybierz kartę kontenera
    .label = Wybierz kartę kontenera
workspace-customize = 
...
floorp-CSK-description = Dostosuj skróty klawiaturowe { -brand-short-name }. { -brand-short-name } zapewnia ponad 80 konfigurowalnych skrótów klawiaturowych - uruchom ponownie { -brand-short-name } , aby zastosować te ustawienia. Zduplikowane skróty klawiaturowe nie będą działać.
disable-fx-actions = 
...
floorp-custom-actions-tab-action = Akcje zakładki
...
gf-floorp-open-tree-style-tab-description = Otwórz panel zakładek w stylu drzewa w panelu bocznym
...
gf-floorp-open-history-sidebar-name = [{ -brand-short-name }] Otwórz panel historii paska bocznego
gf-floorp-open-history-sidebar-description = Otwórz panel historii paska bocznego
gf-floorp-open-synctabs-sidebar-name = [{ -brand-short-name }] Otwórz panel zsynchronizowanych kart na pasku bocznym
...
gf-floorp-open-extension-sidebar-name = [{ -brand-short-name }] Otwórz wybrany dodatek paska bocznego
...
floorp-update-application-auto-enabled-option = 
    .label = Automatycznie sprawdzaj aktualizacje przenośne { -brand-short-name } . (Zalecane)
...
floorp-custom-actions-open-workspaces-preferences = Otwórz ustawienia projektu
...
floorp-custom-actions-show-bsm = Pokaż pasek boczny menedżera przeglądarki
    .label = Pokaż pasek boczny menedżera przeglądarki
