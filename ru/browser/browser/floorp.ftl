...
bsb-preferences = Настройки боковой панели управления браузером
view-sidebar2-right = 
    .label = Отображать боковую панель управления браузером справа
enable-sidebar2 = 
    .label = Включить боковую панель управления браузером
visible-bms = 
    .label = Включить боковую панель управления браузером
...
sidebar2-enable-addons-desc = Если эта настройка включена, блокировка рекламы и другие функции будут работать в боковой панели. Она также увеличивает количество API, доступных для открытых там веб-страниц.
...
bsb-header = Боковая панель управления браузером
...
bsb-add = Добавить веб-панель в боковую панель управления браузером
...
gf-floorp-open-browser-manager-sidebar-name = [{ -brand-short-name }] Открыть боковую панель управления браузером
gf-floorp-open-browser-manager-sidebar-description = Открыть боковую панель управления браузера, если боковая панель управления браузера была загружена
gf-floorp-close-browser-manager-sidebar-name = [{ -brand-short-name }] Закрыть боковую панель управления браузером
