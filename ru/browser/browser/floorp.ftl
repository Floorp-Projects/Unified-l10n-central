...
workspaces-reset-service-title = Рабочие области { -brand-short-name }
...
manage-workspace-on-bms-option = 
    .label = Управлять рабочей областью на боковой панели управления браузера
show-workspace-name-option = 
    .label = Отображать имя рабочей области на кнопке рабочей области
change-workspace-with-default-key-option = 
    .label = Изменить рабочее пространство с помощью клавиш ↑ и ↓ с зажатой клавишей Shift.
workspaces-manage-title = Управление рабочими областями
...
workspaces-manage-label = 
    .label = Управление рабочими областями
workspaces-manage-button = Открыть диспетчер рабочих областей...
...
block-fingerprint = Отпечаток пальца – это механизм отслеживания, который опирается на уникальные возможности вашего браузера и операционной системы. Этот раздел содержит настройки для дальнейшего усиления защиты помимо блокировки по умолчанию.
...
gf-floorp-open-bookmarks-sidebar-name = [{ -brand-short-name } Открыть панель закладок на боковой панели
gf-floorp-open-bookmarks-sidebar-description = Открыть панель закладок на боковой панели
gf-floorp-open-history-sidebar-name = [{ -brand-short-name }] Открыть панель истории на боковой панели
gf-floorp-open-history-sidebar-description = Открыть панель истории на боковой панели
gf-floorp-open-synctabs-sidebar-name = [{ -brand-short-name }] Открыть панель синхронизированных вкладок на боковой панели
...
workspace-prompt-title = Рабочие области { -brand-short-name }
...
welcome-design-floorp-fluerial-name = Fluerial дизайн { -brand-short-name }
...
ssb-page-action-title = Установите этот сайт в качестве приложения
ssb-app-open-button = 
    .label = Открыть в PWA
