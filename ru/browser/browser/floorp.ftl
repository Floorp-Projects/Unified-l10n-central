...
workspace-prompt-title = Рабочие пространства { -brand-short-name }
please-enter-workspace-name = Пожалуйста, введите новое имя рабочего пространства.
please-enter-workspace-name-2 = Имя рабочей области не может содержать символы и пробелы.
workspace-error = Произошла ошибка:
workspace-error-discription = Либо рабочее пространство с таким названием уже существует, либо название недопустимо.
workspace-button = Рабочие пространства
...
workspace-rename = 
    .label = Переименовать это рабочее пространство
workspace-delete = 
