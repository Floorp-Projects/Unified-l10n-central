...
floorp-lepton-enable-bookmarkbar_icon-hide = 
    .label = Приховати значки на панелі закладок
...
floorp-custom-actions-workspace-action = Дії робочих просторів
...
workspace-prompt-title = Робочий простори { -brand-short-name }
please-enter-workspace-name = Будь ласка, введіть нове ім'я робочого простору.
please-enter-workspace-name-2 = Ім'я робочого простору не може містити символів та пробілів.
workspace-error = Виникла помилка:
workspace-error-discription = Робоча область з такою назвою або існує, або назва невірна.
workspace-button = Робочі простори
...
workspace-context-menu-selected-tab = 
    .label = Вибрану вкладку неможливо перемістити
move-tab-another-workspace = 
    .label = Перемістити в інший робочий простір
workspace-rename = 
    .label = Перейменувати цей робочий простір
workspace-delete = 
    .label = Видалити робочий простір
manage-workspace = Керувати цим робочим простором
    .label = Керувати цим робочим простором
...
category-CSK = 
    .label = Гарячі клавіши
    .tooltiptext = Гарячі клавіши
category-CSK-title = Гарячі клавіши
...
shortcut-key-label = Гарячі клавіші
