...
enable-double-click-block = 
    .label = Đóng tab khi nhấn đúp 2 lần
...
enable-userscript = 
    .label = Kích hoạt "userChrome.js" và "Boostrap extensions"
...
bsb-context = Sử dụng Container Tab
bsb-userAgent-label = 
...
use-icon-provider-option = Sử dụng nhà cung cấp Icon
