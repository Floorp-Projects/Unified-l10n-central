...
floorp-show-vertical-tab-newtab-button = 
    .label = Hiện nút "Mở tab mới" bên trong Thanh tab dọc
...
sidebar-preferences = Thanh Sidebar
bsb-preferences = Cài đặt thanh Sidebar
view-sidebar2-right = 
    .label = Hiển thị cài đặt thanh Sidebar bên phải
enable-sidebar2 = 
    .label = Kích hoạt cài đặt Sidebar
visible-bms = 
    .label = Hiển thị cài đặt Sidebar
hide-bms-to-unload-panel = 
    .label = Tắt tải panel khi ẩn
custom-URL-option = Thêm Web Panels URLs
set-custom-URL-button = 
    .label = Thêm URLs tùy chọn...
    .accesskey = S
...
use-icon-provider-option-yandex = 
    .label = Yandex ( hiệu lực ở Trung Quốc)
use-icon-provider-option-hatena = 
    .label = Hatena ( hiệu lực ở Trung Quốc)
