...
gf-floorp-open-extension-sidebar-name = [Floorp] 打开所选的侧边栏插件
gf-floorp-open-extension-sidebar-description = 打开所选的侧边栏插件
...
update-portable-notification-success-message = 更新成功！希望您喜欢 Floorp 的新版本！
