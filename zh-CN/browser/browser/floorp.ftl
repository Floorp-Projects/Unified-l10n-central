...
memo-third-tip = { -brand-short-name } 笔记将会保存在您的 { -brand-short-name } 设置中，并通过 Firefox Sync 在不同设备之间同步。Firefox Sync 会使用您的 Firefox 账户密码对同步的内容进行加密，因此除了您自己，没有其他人能够知道其内容。
