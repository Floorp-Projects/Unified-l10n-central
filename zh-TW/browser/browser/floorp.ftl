...
welcome-discribe-floorp = { -brand-short-name } 是一款基於 Firefox 開發，提供豐富的客製化功能的瀏覽器，並支援多個平台。
...
welcome-discribe-browser-design = 您可以在 { -brand-short-name } 上選用第三方設計的精美介面。部分系統特有的介面設計也可在偏好設定中找到。
