...
gf-floorp-show-browser-manager-sidebar-name = [{ -brand-short-name }] 切換管理工具側邊欄
gf-floorp-show-browser-manager-sidebar-description = 切換管理工具側邊欄
gf-floorp-hide-statusbar-name = [{ -brand-short-name }] 隱藏狀態列
gf-floorp-hide-statusbar-description = 隱藏狀態列
gf-floorp-show-statusbar-name = [{ -brand-short-name }] 切換狀態列
...
welcome-finish-setup-description = 您已經設定完成！其他的像是垂直分頁以及擴充套件等功能可以在 "設定"中找到。開始暢享 { -brand-short-name } 吧！
...
shortcutkey-customize = 
    .title = 鍵盤快捷鍵
select-shortcutkeyAction = 選擇一個要觸發的動作
...
shortcut-key-description = 點擊 "開始收錄" 然後為此動作輸入您的鍵盤快捷鍵。可以使用多重組鍵但是如果其他動作已經安排相同鍵位的話將無效。
