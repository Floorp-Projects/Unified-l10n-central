...
welcome-select-preferences-template = 選擇瀏覽器介面模板
welcome-minimum-template = 簡易
welcome-enable-basic-features = 提供基礎功能及簡便的使用體驗。
welcome-medium-template = 預設
welcome-enable-some-features = 提供更多功能以及更好的體驗。
welcome-maximum-template = 進階
